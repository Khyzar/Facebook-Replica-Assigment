<%@ Page Title="" Language="C#" MasterPageFile="~/motheroffinal.Master" AutoEventWireup="true" CodeBehind="Notifications.aspx.cs" Inherits="facebook_web.Notifications" %>
...
<div class="main_panel_notification_settings_pos"><a href="home.aspx"> <temp class="main_panel_notification_settings_link">Notification Settings</temp>  
</a></div>
<hr class="hr_class5" />

<div class="get_notification_via">
Get Notification via: &nbsp<a href="motherofhome.aspx">RSS</a>
</div><br /><br />
